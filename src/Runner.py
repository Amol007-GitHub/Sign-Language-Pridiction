from ReportGenerator import saveTestResults
from Train import trainLDA, trainSVM
from Test import testLDA, testSVM
from ReportGenerator import plotConfusionMatrix
